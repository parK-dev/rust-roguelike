...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(2, RED, BLACK, "Your quest had ended.");
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "The Amulet of Yala remains unclaimed, and yourhome town \
            is doomed.",
        );
        ctx.print_color_centered(8, YELLOW, BLACK, "That is, unless a new hero arises...");
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ctx.set_active_console(2);
        ctx.print_color_centered(2, GREEN, BLACK, "You have found the amulet!");
        ctx.print_color_centered(
            4,
            WHITE,
            BLACK,
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "Your hometown is saved, and you can now return to your normal life.",
        );
        ctx.print_color_centered(10, GREEN, BLACK, "Press 1 to play again.");
